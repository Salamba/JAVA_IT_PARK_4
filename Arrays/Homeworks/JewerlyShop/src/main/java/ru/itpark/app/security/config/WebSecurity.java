...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/jewerlymodels/**").permitAll()
                .antMatchers("/jewerly/**").permitAll()
                ...
                .defaultSuccessUrl("/addnewjewerly") // на какую страницу следует выполнить переадресацию в случае успеха
