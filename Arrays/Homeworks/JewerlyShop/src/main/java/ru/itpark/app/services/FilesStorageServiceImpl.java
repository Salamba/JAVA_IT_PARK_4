...
public class FilesStorageServiceImpl implements FilesStorageService {
    ...
    @Override
    public String saveImage(MultipartFile file, JewerlyModel jewerlyModel) {
        ...
        if (jewerlyModel.getImage()!= null) {
            jewerlyModel.getImage().setJewerlyModel(null);
            fileInfoRepository.save(jewerlyModel.getImage());
         }
       //  кладем эту картинку машине
        fileInfo.setJewerlyModel(jewerlyModel);
        fileInfoRepository.save(fileInfo);
